...
function CombatModal(props) {
    ...
    function playerAttack() {
			...
			if (attackRoll-props.playerStats.attackBonus === 20) {
                ...
                setCombatMessage(`You rolled a Natural 20 for a critical hit! You make a devastating strike on the ${props.enemyStats.nameLower} with your ${props.playerStats.items.weapon.name} for ${damage*2} damage!`)
    ...
    function enemyAttack() {
        ...
        const attackRoll = Math.floor(Math.random()*21+props.enemyStats.attackBonus)
			if (attackRoll-props.enemyStats.attackBonus === 20) {		
				...
				setCombatMessage(`The ${props.enemyStats.nameLower} rolled a Natural 20 for a critical hit! The ${props.enemyStats.nameLower} makes a devastating strike against you! You take ${damage*2} damage!`)
